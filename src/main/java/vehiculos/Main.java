...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Pais mas vendedor: " + Pais.paisMasVendedor().getNombre());
        System.out.println("Fabricante con mas ventas: " + Fabricante.fabricaMayorVentas().getNombre());
